...
<div class="active">
	...
	try{
		...
		conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/drugdatabase","root","123456");
		...
		%>
			<div class="row">
 				<div class="column">
    				<div class="card">
    				<img src="images/pills.jpg" width=180 height=200>
					...
					%>
  					...
  					<input type="number" name="orderquantity" onkeypress="return 
